...
export const VAULT_FETCH_ALLOWANCES_BEGIN = 'VAULT_FETCH_ALLOWANCES_BEGIN';
export const VAULT_FETCH_ALLOWANCES_SUCCESS = 'VAULT_FETCH_ALLOWANCES_SUCCESS';
export const VAULT_FETCH_ALLOWANCES_FAILURE = 'VAULT_FETCH_ALLOWANCES_FAILURE';