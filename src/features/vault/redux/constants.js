...
export const VAULT_FETCH_STAKE_APPROVAL_BEGIN = 'VAULT_FETCH_STAKE_APPROVAL_BEGIN';
export const VAULT_FETCH_STAKE_APPROVAL_SUCCESS = 'VAULT_FETCH_STAKE_APPROVAL_SUCCESS';
export const VAULT_FETCH_STAKE_APPROVAL_FAILURE = 'VAULT_FETCH_STAKE_APPROVAL_FAILURE';
...
export const VAULT_FETCH_STAKE_BEGIN = 'VAULT_FETCH_STAKE_BEGIN';
export const VAULT_FETCH_STAKE_SUCCESS = 'VAULT_FETCH_STAKE_SUCCESS';
export const VAULT_FETCH_STAKE_FAILURE = 'VAULT_FETCH_STAKE_FAILURE';

export const VAULT_FETCH_WITHDRAW_STAKE_BEGIN = 'VAULT_FETCH_WITHDRAW_STAKE_BEGIN';
export const VAULT_FETCH_WITHDRAW_STAKE_SUCCESS = 'VAULT_FETCH_WITHDRAW_STAKE_SUCCESS';
export const VAULT_FETCH_WITHDRAW_STAKE_FAILURE = 'VAULT_FETCH_WITHDRAW_STAKE_FAILURE';
